[![Passing Tests on master](https://travis-ci.org/oliverlorenz/repo-baseline-ruleset-plugins.svg?branch=master)](https://travis-ci.org/oliverlorenz/repo-baseline-ruleset-plugins)
